...
export default class RequestedAssignProperyView extends Component {
    constructor() {
        super();
        this.state = {
                                                    ...
                                                    <div className="col-md-12 col-sm-12">
                                                        <div className="property_block_wrap style-2 p-4">
                                                            <div className="prt-detail-title-desc justify-content-between d-flex">
                                                                <h3 className="mb-0">
                                                                    <Link to="/admin/requested/assign/property" className="text-success" color="success"><i className="fas fa-chevron-left fs-5 mr-2"></i></Link>
                                                                    {item.name}
                                                                </h3>
                                                            </div>
                                                        </div>
