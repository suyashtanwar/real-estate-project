...
export default class ViewPropertyDetails extends Component {
    ...
    ViewPropertyInfo = (e) => {
        ...
        axios
            .post(APIURL + "agent/view-assign-property", formData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            })
            .then((response) => {
                console.log("agent/view-assign-property", response.data.data)
                this.setState({
                    Loader: false,
                                        ...
                                        <div className="row">
                                                    ...
                                                    <div className="col-md-12 col-sm-12">
                                                        <div className="property_block_wrap style-2 p-4">
                                                            <div className="prt-detail-title-desc justify-content-between d-flex">
                                                                <h3 className="mb-0"> <Link className="text-success mb-3" to={"/agent/assigned/property/"} > <i className="fas fa-chevron-left fs-5 mr-2"></i> </Link>
                                                                    {item.name} </h3>
                                            ...
                                            <div className="col-3">
                                                <div className="d-grid gap-4 mt-2">
                                                            ...
                                                            <CardTitle tag="h5">
                                                                {
                                                                    item.propertyAssignedStatus === "accept" ?
                                                                        item.propertyVerifiedStatus === "verify"
                                                                            ...
                                                                            :
                                                                            item.resend_property === "resend" ?
                                                                                <div>
                                                                                    <Button size="sm" type="button" color="success" className="btn-block" outline onClick={(e) => this.onSubmit(item, "verify")}>Verify</Button>
                                                                                    <Button size="sm" type="button" color="danger" className="btn-block" outline onClick={(e) => this.CommetModal(item)}>Not Verify</Button>
                                                                                </div>
                                                                                :
                                                                                item.propertyVerifiedStatus === "unverify" ?
                                                                                    <Button
                                                                                        ...
                                                                                        className="btn btn-theme-light-1 rounded btn-block"
                                                                                    >Not Verified</Button>
                                                                        ...
                                                                        :
                                                                        <div>
                                                                            <Button size="sm" type="button" color="success mr-1" className="btn-block" outline onClick={(e) => this.SubmitRequest(item, "accept")} >Accept</Button>
                                                                            <Button size="sm" type="button" color="danger mr-1" className="btn-block" outline onClick={(e) => this.SubmitRequest(item, "reject")} >Reject</Button>
                                                                        </div>
                                                                }
                                                            </CardTitle>
                                                        </CardBody>
                                                        ...
                                                        item.propertyVerifiedStatus === "unverify" ?
                                                            item.comment === null ? "" :
                                                                <Card>
                                                                    <CardBody>
                                                                        <div>
                                                                            <CardTitle tag="h5" className="border-bottom mb-3 pb-3">COMMENT</CardTitle>
                                                    ...
                                                    <Modal className="resido-admin" size="md" isOpen={this.state.CommetModal} toggle={() => this.ModalClose()}>
                                                        <ModalHeader className="" toggle={() => this.ModalClose()}>
                                                            Comment <strong className="text-danger" >*</strong> <br />
                                                        ...
                                                        <ModalFooter>
                                                            <div className="d-flex justify-content-between w-100">
                                                                <Button color="primary" className="btn btn-primary" onClick={(e) => this.VerifyingRequest(item, "unverify")}> <i className="fas fa-save mr-1"> </i>Submit</Button>
                                                    ...
                                                    <Modal className="resido-admin" size="lg" isOpen={this.state.imageModal} toggle={() => this.imageModal()} autoFocus={false}>
                                                        ...
                                                        <ModalBody>
                                                            <Carousel indicators={false} interval="300000" activeIndex={this.state.topImgIdx} onSelect={this.handleSelectTop}>
