...
export default class VerifiedProperty extends Component {
    ...
    getVerifiedProperty = () => {
        ...
        axios
            .post(APIURL + "agent/get-verified-propery-list", formData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            })
            .then((response) => {
                console.log("agent/get-verified-propery-list", response.data.data.data)
                this.setState({
        ...
        // const response = await axios.post(APIURL + 'agent/get-verified-propery-list', formData, {
        //     headers: {
        //         'Authorization': `Bearer ${token}`
        //     }
        // })
        ...
        //         Loader: false
        //     }, () => {
        //         console.log("propertyRequest", this.state.propertyRequest)
        //     })
        // }
    }
    ...
    render() {
        ...
        if (this.state.goToPreviewVeri) {
            return <Redirect to={"/agent/verified/property/details/" + this.state.ViewPropertyId} push={true} />;
        }
        return (
